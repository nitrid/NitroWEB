function UretimTamamlama($scope,srv,$rootScope,$filter)
{
    $scope.Init = async function () 
    {
        $scope.Firma = localStorage.getItem('firm');
        $scope.Param = srv.GetParam(atob(localStorage.getItem('login')));
        $rootScope.PageName = "ÜRETİM TAMAMLAMA";
        ...
        await GetPlanlananIsEmrileri("#FFFFFF");
    }
    async function GetPlanlananIsEmrileri(pColor)
    {
